    ...
    <div className="flex flex-col gap-1.5 px-6 pt-5">
      <div className="flex flex-wrap items-center gap-3">
        ...
        <button
          ...
          title={t("flows.editor.backToFlows")}
          aria-label={t("flows.editor.backToFlows")}
        ...
        <input
          ...
          placeholder={t("flows.editor.flowNamePlaceholder")}
          spellCheck={false}
          aria-label={t("flows.editor.flowName")}
        ...
        {dirty && (
          <span
            ...
            title={t("flows.editor.unsavedChangesTitle")}
            aria-live="polite"
          >
            <span className="h-1.5 w-1.5 rounded-full bg-amber-400" />
            {t("flows.editor.edited")}
          </span>
        )}
        ...
        <div className="ml-auto flex flex-wrap items-center gap-1.5">
          ...
          {state.status === "active" ? (
            ...
            <Button
              ...
              title={
                !canActivate
                  ? t("flows.editor.fixIssuesToActivate")
                  : undefined
              }
            >
              {activating ? (
      ...
      <input
        ...
        placeholder={t("flows.editor.descriptionPlaceholder")}
        aria-label={t("flows.editor.flowDescription")}
