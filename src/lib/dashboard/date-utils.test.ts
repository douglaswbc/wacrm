...
describe("mondayIndex", () => {
  it("maps Monday → 0 and Sunday → 6", () => {
    // Construct dates in LOCAL time — a bare ISO date string ("2026-05-18")
    // is parsed as UTC midnight and can shift a day back in negative-offset
    // timezones (e.g. Brazil).
