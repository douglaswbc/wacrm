...
import { MEDIA_TOOLS } from '@/lib/ai/media-tools'
...
export async function GET() {
  try {
    ...
    // Calendar connection is live for this account. CRM and media
    // library tools are always available.
    let nativeTools = [...NATIVE_TOOLS, ...CRM_TOOLS, ...MEDIA_TOOLS]
    try {
